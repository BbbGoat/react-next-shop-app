...
const ListSlider = ({ sliderName, title, subtitle, data, slidesPerView, ...restProps }: IListSliderProps) => {
  return (
    <div className={`${styles.slider} ${sliderName}`}>
      ...
      */}
      ...
      <div className={styles.mobileSwiper}>
        ...
        <div className={styles.container}>
          {/* 리스트 슬라이드 */}
          <Swiper modules={[Pagination]} slidesPerView={"auto"} spaceBetween={15} freeMode={true}>
            {data.map((item, idx) => {
              const { imageURL, brand, name, originPrice, salePrice, src } = item;
